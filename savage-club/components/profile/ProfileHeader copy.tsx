          ...
          <div className="flex items-start justify-between gap-2">
            ...
            {!isOwner && (
              <div className="relative">
                <button onClick={() => setShowOptions((v) => !v)} className="text-white/40 hover:text-white p-1 transition-colors">
                ...
                {showOptions && (
                  <div className="absolute right-0 top-8 bg-[#2A1356] border border-white/10 rounded-xl shadow-2xl overflow-hidden z-20 w-44">
                    <button className="w-full text-left px-4 py-3 text-sm text-white/70 hover:bg-white/5 hover:text-white transition-colors">🔗 Partager le profil</button>
                    <button className="w-full text-left px-4 py-3 text-sm text-white/70 hover:bg-white/5 hover:text-white transition-colors">🚩 Signaler</button>
                    <ReportButton type="user" id={user.id} variant="text" />
                    <button className="w-full text-left px-4 py-3 text-sm text-red-400 hover:bg-red-500/10 transition-colors">🚫 Bloquer</button>
                  </div>
                )}
              </div>
            )}
